...
<div dir="ltr">
    ...
    <span class="preheader" style="display: none !important; visibility: hidden; opacity: 0; color: transparent; height: 0; width: 0;"> Find the confirmation details here.  </span>
    ...
    <p>
    <br/>
    Dear {{ strtoupper($user->name) }},<br/><br/>

    For your information:<br/><br/>
    This email is to confirm that you have declined the Request to Book your <br/>
    boardroom from a potential customer with the following details. <br /><br />
    ...
    Guest Name: {{ $email_array['guest_name'] }} <br /><br/>

    The hold on this boardroom has now been removed.<br /><br/>
