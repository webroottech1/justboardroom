...
<p>
<br/>
Hi {{ strtoupper($user->name) }},<br/><br/>
Welcome to Just Boardrooms. In order to start the process of listing your first boardroom, please confirm your email address by clicking the link below.
<br/>
<a href="{{url('user/verify', $user->verifyUser->token)}}">Confirm Email</a><br /><br />
